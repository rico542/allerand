...
// @include		*.world-of-dungeons.fr/wod/spiel/tournament/*duell.php*
// @grant GM_addStyle
// @grant GM_getValue
// @grant GM_listValues
// ==/UserScript==
...
var Contents = {
	...
	OrigTextList_ActionType		: [["attacks", "ranged attacks", "attacks with magic", "socially attacks", "cunningly attacks", "activates on", "works as a force of nature upon", "infected", "casts an explosion at", "deactivated", "magic projectile", "curse", "scare", "bannit", "heals with", "uses", "summons with", "is unable to do anything.", "looks around in boredom and waits."],
					   ["近战攻击", "远程攻击", "魔法攻击", "心理攻击", "偷袭", "触发", "做为自然灾害", "散布", "制造爆炸", "解除", "魔法投射", "诅咒", "恐吓", "治疗", "使用", "召唤", "不能执行任何动作.", "无聊的打量四周，等待着.", "bannit"],
					   ["frappe avec", "tire avec", "incante", "déstabilise avec", "s'embusque", "se déclenche avec", "lance une force de la nature", "infecte", "produit une explosion sur", "désamorce", "PROJECTILE MAGIC", "MALEDICTION", "terrorise", "désoriente avec", "cherche une solution avec", "lance", "bannit", "soigne avec", "agit", "invoque avec", "ne peut rien faire.", "s'ennuie et attend la suite."]],
	OrigTextList_DamageType		: [["crushing damage", "cutting damage", "piercing damage", "fire damage", "ice damage", "lightning damage", "poison damage", "acid damage", "psychological damage", "holy damage", "disarm trap", "mana damage"],
					   ...
					   ["dégâts contondants", "dégâts tranchants", "dégâts perforants", "dégâts de feu", "dégâts de glace", "dégâts électriques", "dégâts de poison", "dégâts d'acide", "dégâts psychologiques", "dégâts saints", "dégâts de désamorçage", "dégâts de mana"]],
	...
	TextList_AttackType		: [["melee", "ranged", "spell", "social", "ambush", "trap", "nature", "disease", "detonate", "disarm trap", "magic projectile", "curse", "scare"],
					   ...
					   ["Combat rapproché", "Combat à distance", "Sortilège", "Social", "Embuscade", "Déclenchement", "Force de la nature", "Maladie", "Explosion", "Désactivation", "Projectile Magique", "Malédiction", "Effroi", "Désorientation", "Orientation", "Immobilisation", "Bannissement"]],
