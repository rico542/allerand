// ==UserScript==
// @name           Filtrer le rapports de donjons
...
function montre_filtrage () {
    if (document.getElementById('heros_options')) {
        ...
        style_css.innerHTML = '.vue_heros_options { position: fixed; background-color: red; border: '+
            '1px solid white;padding: 0.5em; z-index: 9999; }'+
            '.lst_heros {margin:0 0.2em;padding:0.2em 0.5em;}'+
            '.lst_heros_inside {float:left; margin-right:0.5em;padding:0em;}'+
            '.lst_heros_label {font-size: 14px;font-style: bold;color: black;margin-right: 0.3em;}'+
            '.lst_tous_aucun {font-size: 10px;font-style: bold;color: black;width:100%;text-align:right;margin: 0;padding:0.1em 0;}';
