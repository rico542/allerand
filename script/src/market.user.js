...
// @namespace		tomy
// @include			*.world-of-dungeons.fr/wod/spiel/hero//csvexport.php*
// @include			*.world-of-dungeons.fr/wod/spiel/hero/items.php*
// @version			1.2.2
...
function ParseTreasure(text)
{
	...
	for (var i = 1; i < lines.length; ++i) {
		...
		if (ccount.length > 0) {
			...
			// treasury
			if (!ret.Treasury.hasOwnProperty(place)) ret.Treasury[place] = [];
